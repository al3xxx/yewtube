...
class ConfigItem:
    ...
    def set(self, value, is_temp=False):
        ...
        if self.require_known_player and not util.is_known_player(
            Config.PLAYER.get
        ):
...
class _Config:
    ...
    _configitems = [
        ...
        ConfigItem(
            "window_pos", "", check_fn=check_win_pos, require_known_player=True
        ),
        ConfigItem(
            "window_size",
            "",
            check_fn=check_win_size,
        ...
        ConfigItem(
            "audio_format", "auto", allowed_values="auto webm m4a".split()
        ),
        ConfigItem(
            "video_format", "auto", allowed_values="auto webm mp4 3gp".split()
        ),
    ...
    def load(self):
        ...
        if os.path.exists(g.CFFILE):
            ...
            if isinstance(self.PLAYERARGS.get, list):
                ...
                redundant = "-really-quiet --really-quiet -prefer-ipv4 -nolirc -fs --fs".split()
